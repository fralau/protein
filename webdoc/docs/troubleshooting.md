...
2. **Undefined Variables**: A variable used in an expression is not defined in the current context or scope. Ensure all variables are declared within `.context` or passed correctly.  
